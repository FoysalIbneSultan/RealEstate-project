                        ...
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
									...
									<?php $query=mysqli_query($con,"SELECT property.*, user.uname,user.uphone,user.uemail, user.utype,user.uimage FROM `property`,`user` WHERE property.uid=user.uid ORDER BY date DESC LIMIT 9");
                                        ...
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            ...
                                            <div class="featured-thumb-data shadow-one">
                                                ...
                                                <div class="p-3">
                                                    ...
                                                    <div class="float-left text-capitalize"><i class="fas fa-phone text-success mr-1"></i> Contact Number  : <?php echo $row['uphone'];?></div> <br/>
                                                    <div class="float-left text-capitalize"><i class="fas fa-envelope text-success mr-1"></i> Email : <?php echo $row['uemail'];?></div> <br/>
